            ...
            <div className="bg-background flex min-h-screen">
                ...
                <ScrollArea className="h-screen w-full xl:pl-5">
                    ...
                    <div className="px-4 py-12 md:max-w-sm">
                        ...
                        <div className="flex flex-col gap-4">
                            <div>
                                {error === "Firebase: Error (auth/email-already-in-use)." &&
                                    <p className="text-destructive text-sm">Email is already in use!</p>}
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <Label htmlFor="terms" className="text-sm">I accept the <Link to="/legal/privacy-policy"
                                                                                              target="_blank"
                                                                                              className="underline">Privacy
                                    Policy</Link> and the <Link to="/legal/terms-of-service" target="_blank"
                        ...
                        <div className="mt-8">
                            <Button size="lg" className="w-full" disabled={!email || !password || !checked}
